...
public class User
{
    ...
    // IdProofingValiditySettings.ValidityYears. Storing a baked-in expiration date
    ...
    [Obsolete("Expiration is computed from IdProofingCompletedAt + IdProofingValiditySettings.ValidityYears. Do not read or write this field for new code.")]
