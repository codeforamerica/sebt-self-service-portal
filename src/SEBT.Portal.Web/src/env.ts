...
export const env = createEnv({
  ...
  server: {
    ...
    OIDC_CO_DISCOVERY_ENDPOINT: z.string().url().optional(),
    OIDC_CO_CLIENT_ID: z.string().optional(),
    OIDC_CO_CLIENT_SECRET: z.string().optional(),
    OIDC_CO_REDIRECT_URI: z.string().url().optional(),
    OIDC_CO_LANGUAGE_PARAM: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    OIDC_CO_DISCOVERY_ENDPOINT: process.env.OIDC_CO_DISCOVERY_ENDPOINT,
    OIDC_CO_CLIENT_ID: process.env.OIDC_CO_CLIENT_ID,
    OIDC_CO_CLIENT_SECRET: process.env.OIDC_CO_CLIENT_SECRET,
    OIDC_CO_REDIRECT_URI: process.env.OIDC_CO_REDIRECT_URI,
    OIDC_CO_LANGUAGE_PARAM: process.env.OIDC_CO_LANGUAGE_PARAM,
