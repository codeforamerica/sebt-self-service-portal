...
import { OutagePageContent } from './OutagePageContent'

vi.mock('./getOutageMessages', () => ({
  getOutageMessages: () => [
    {
      language: 'en',
