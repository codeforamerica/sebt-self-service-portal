...
//
// This file ships as part of the static export but is REPLACED in the deployed
// bucket per environment by scripts/ci/write-checker-config.sh — that is what
// lets one build artifact run anywhere. Leaving it empty falls back to the
// values baked in at build time, which is what local development and tests rely on.
//
...
//   amplitudeApiKey, mixpanelToken, siteImproveId,
